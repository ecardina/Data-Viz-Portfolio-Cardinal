...
|-------------------------|--------------------------------|-------------|-------------|
| How would you describe the story being told?  | - Story is clear in telling me about sportswashing and that it is bad in England    - Call to action is a little cloudy| - Clearly defined “sportswashing” and gave examples  - Unsure about how the “Celebrity Investors in Soccer” ties into the whole story           |             |
